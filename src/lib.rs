// src/lib.rs
/*
 * Core library for BitbucketFlow
 */
...
#[derive(Debug)]
pub struct BitbucketFlowProcessor {
    verbose: bool,
    processed_count: usize,
}

impl BitbucketFlowProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting BitbucketFlow processing");
    
    let mut processor = BitbucketFlowProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = BitbucketFlowProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = BitbucketFlowProcessor::new(false);
